...
abstract class AppLocalizations {
  ...
  /// No description provided for @syncResolveAction.
  ///
  /// In en, this message translates to:
  /// **'Resolve synchronization conflicts'**
  String get syncResolveAction;

  /// No description provided for @syncResolveTitle.
  ///
  /// In en, this message translates to:
  /// **'Resolve {domain} conflict'**
  String syncResolveTitle(String domain);

  /// No description provided for @syncResolveMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @syncNoConflict.
  ///
  /// In en, this message translates to:
  /// **'No synchronization conflict was found.'**
  String get syncNoConflict;

  /// No description provided for @syncResolutionFailed.
  ///
  /// In en, this message translates to:
  /// **'Conflict resolution failed. No baseline was changed.'**
  String get syncResolutionFailed;

  /// No description provided for @syncDomainProjects.
  ///
  /// In en, this message translates to:
  /// **'projects'**
  String get syncDomainProjects;
  ...
  /// No description provided for @syncDomainFocus.
  ///
  /// In en, this message translates to:
  /// **'timer'**
  String get syncDomainFocus;
